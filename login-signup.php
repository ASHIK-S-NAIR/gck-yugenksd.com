...
if($row>0)
{
  ...
  $sql = "SELECT custid FROM customer WHERE username='$uname' and password='$password'";
  $result= mysqli_query($conn, $sql);
  $custid= mysqli_fetch_all($result, MYSQLI_ASSOC);
  $_SESSION['custid']=$custid[0]['custid'];
...
<div id="id01" class="modal">
  ...
  <form class="modal-content animate" method="post" autocomplete="off">
   ...
   <center> <input type="submit" class="loginbutton" name="userlogin" value="USER LOGIN"><br>
      <p>OR</p>
      <input type="submit" onclick="window.location.href='signup.php'" class="loginbutton" name="signup" value="Sign Up"><br>
 </center> 
    </div>
